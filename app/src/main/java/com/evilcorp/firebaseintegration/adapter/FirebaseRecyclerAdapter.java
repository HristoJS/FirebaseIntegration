 ...
 *           Message.class, android.R.layout.two_line_list_item, ChatMessageViewHolder.class, ref) {
 ...
 */
abstract class FirebaseRecyclerAdapter<T, VH extends RecyclerView.ViewHolder>
        extends RecyclerView.Adapter<VH> {
    private static final String TAG = "FirebaseRecyclerAdapter";

    private final FirebaseArray mSnapshots;
    private final Class<T> mModelClass;
    private final Class<VH> mViewHolderClass;
    private final int mModelLayout;

    private FirebaseRecyclerAdapter(Class<T> modelClass,
        ...
        mSnapshots.setOnChangedListener(new FirebaseArray.OnChangedListener() {
            @Override
            public void onChildChanged(FirebaseArray.OnChangedListener.EventType type, int index, int oldIndex) {
                switch (type) {
                    case ADDED:
